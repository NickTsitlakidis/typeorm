        ...
        if (this.embeddedMetadata) {
            ...
            var extractEmbeddedColumnValue_2 = function (propertyNames, value) {
                ...
                if (propertyName) {
                    ...
                    var isMongoColumn = _this.entityMetadata.connection.options.type === "mongodb";
                    if (isMongoColumn) {
                        if (Array.isArray(value)) {
                            var mappedArray_1 = [];
                            value.forEach(function (arrayElement) {
                                var _a, _b, _c;
                                var mappedArrayElement = extractEmbeddedColumnValue_2(propertyNames, arrayElement[propertyName]);
                                if (Object.keys(mappedArrayElement).length > 0) {
                                    mappedArray_1.push((_a = {}, _a[propertyName] = mappedArrayElement, _a));
                                }
                                else {
                                    if (Array.isArray(mappedArrayElement)) {
                                        mappedArray_1.push((_b = {}, _b[propertyName] = [], _b));
                                    }
                                    else {
                                        mappedArray_1.push((_c = {}, _c[propertyName] = {}, _c));
                                    }
                                }
                            });
                            return mappedArray_1;
                        }
                        else {
                        ...
                        var submap = extractEmbeddedColumnValue_2(propertyNames, value[propertyName]);
                        if (Object.keys(submap).length > 0) {
                            return _b = {}, _b[propertyName] = submap, _b;
                        }
                    }
                    return {};
                }
                ...
                if (value[_this.propertyName] !== undefined && (returnNulls === false || value[_this.propertyName] !== null)) {
                    return _c = {}, _c[_this.propertyName] = value[_this.propertyName], _c;
                }
                return {};
            };
             ...
             */
            if (this.relationMetadata && !((_c = Object.getOwnPropertyDescriptor(entity, this.relationMetadata.propertyName)) === null || _c === void 0 ? void 0 : _c.get) && entity[this.relationMetadata.propertyName] && entity[this.relationMetadata.propertyName] instanceof Object) {
